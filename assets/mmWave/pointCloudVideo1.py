...
def animate_point_cloud_folder(folder_path, file_prefix):
    ...
    ax.set_ylabel('Y')
    ax.set_zlabel('Z')
    sc = ax.scatter([], [], [], c='darkblue')  # 设置点云颜色为浅蓝色
...
# 播放点云数据文件夹
folder_path = r'C:\Users\Kano\Desktop\radar_toolbox_1_30_01_03\tools\visualizers\Industrial_Visualizer\binData\traindata\3tumble\15\pHistBytes_clustered'
